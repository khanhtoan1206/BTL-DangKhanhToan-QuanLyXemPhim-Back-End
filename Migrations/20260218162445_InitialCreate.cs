    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Description", "DisplayOrder", "Name", "Slug", "Status" },
                values: new object[,]
                {
                    { 1, "Phim hành động kịch tính.", 1, "Hành động", "hanh-dong", true },
                    { 2, "Phim lãng mạn.", 1, "Tình cảm", "tinh-cam", true },
                    { 3, "Phim ma rùng rợn.", 1, "Kinh dị", "kinh-di", true },
                    { 4, "Phim cho thiếu nhi.", 1, "Hoạt hình", "hoat-hinh", true },
                    { 5, "Phim khoa học viễn tưởng.", 1, "Viễn tưởng", "vien-tuong", true }
                });
